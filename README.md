...
🔭 Currently shipping **[Looply](https://github.com/Ali-Slaimia/Ali-Slaimia/tree/main/looply)** (Duolingo for code), **[ForgePipe](https://github.com/Ali-Slaimia/forgepipe)** (AWS serverless pipeline), **[RoleRadar](https://github.com/Ali-Slaimia/roleradar)** + **[InterviewArena](https://github.com/Ali-Slaimia/interviewarena)**, and **[SkyPulse](https://sky-pulse-ali.netlify.app)**. Open to full-stack roles in Europe.
...
### Featured projects
- **[looply](https://github.com/Ali-Slaimia/Ali-Slaimia/tree/main/looply)** — Duolingo for developers: daily JS/TS/Python/React/SQL drills, streaks, hearts, XP, leagues, and a winding skill path. Progress lives in the browser.
